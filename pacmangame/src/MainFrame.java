...
public class MainFrame extends JFrame {
	...
	JButton passBtn = new JButton("비밀번호 변경");
	JButton deleBtn = new JButton("회원정보 삭제");
	...
	MainFrame(Operator _o){
		...
		joinBtn.setPreferredSize(new Dimension(120, 25));
		exitBtn.setPreferredSize(new Dimension(120, 25));
		passBtn.setPreferredSize(new Dimension(120, 25));
		deleBtn.setPreferredSize(new Dimension(120, 25));
	...
	class ButtonListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			else if(b.getText().equals("비밀번호 변경")) {
				o.af.setVisible(true);
			}
			else if(b.getText().equals("회원정보 삭제")) {
